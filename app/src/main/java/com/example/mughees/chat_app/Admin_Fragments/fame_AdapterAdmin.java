...
public class fame_AdapterAdmin extends RecyclerView.Adapter<fame_AdapterAdmin.ViewHolder> {
    private Context mContax;
    private List<fame> fames;

    public fame_AdapterAdmin(Context mContax, List<fame> fames) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        return new fame_AdapterAdmin.ViewHolder(v);
    }
            ...
            public boolean onLongClick(View v) {
                ...
                builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        viewHolder.reference.orderByChild("name").equalTo(user_fame.getName()).addListenerForSingleValueEvent(new ValueEventListener() {
                            @Override
